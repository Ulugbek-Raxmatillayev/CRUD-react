...
const AdminCategory = () => {
    ...
    const addItem = () => {
        ...
        axios.post(`${apiUrl}category/save?productUnits=KG`, newData, config)
            .then(res => {
    ...
    const editItem = (id) => {
        ...
        axios.put(`${apiUrl}category/update/${id}?productUnits=KG`, editData, config)
            .then(res => {
                setCategories(res.data.body)
    ...
    const deleteCategory = (id) => {
        axios.delete(`${apiUrl}category/${id}`, config)
            .then(res => {
                setCategories(res.data.body)
                getCategory()
                openDelete()
    ...
    return (
        <AdminScreen title={"Categories"} footerTxt={"admin-controller"}>
            <div>
                <button onClick={openAdd} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Category</button>
            </div>
